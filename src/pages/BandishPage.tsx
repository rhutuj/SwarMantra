  ...
  return (
    <div>
      <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
        <div>
          <h1 className="text-3xl font-semibold">Bandish Detail</h1>
          <p className="text-slate-600">Bandish ID: {bandishId}</p>
        </div>
        <button className="rounded-lg bg-slate-900 px-4 py-2 text-white">Edit Bandish</button>
      </div>
        ...
        <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <div className="mt-4 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            <div>
              ...
              <p className="mt-2 text-slate-700">Unknown</p>
            </div>
            <div>
              <h3 className="text-sm font-medium text-slate-500">Lyrics</h3>
              <p className="mt-2 text-slate-700">Placeholder lyrics.</p>
            </div>
          </div>
        </section>
        ...
        <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <div className="mt-4 space-y-4">
            ...
            <div>
              ...
              <textarea className="mt-2 h-24 w-full rounded-xl border border-slate-200 bg-slate-50 p-3 text-sm text-slate-800" readOnly value="Use the notation editor to add your Bandish content." />
            </div>
          </div>
        </section>
      </div>
